 ...
 * Alok Bhawankar
 * PA 06
 * SSC Lab 4: Macroprocessor Pass 2
 */
...
public class MacroprocessorPass2 {
    ...
    static void pass2() throws Exception {
        input = new BufferedReader(new InputStreamReader(new FileInputStream("Output.txt")));
        //pass 1 as INPUT
        PrintWriter output = new PrintWriter(new FileOutputStream("ALA2_table.txt"), true);
